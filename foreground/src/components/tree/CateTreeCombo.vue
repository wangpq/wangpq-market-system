<template>
    <div id="CateTreeCombo" tabindex="1" class="tree-select ivu-input" v-on:dblclick="showTree" @blur="treeShow=false">
        {{nodeName}}
  ...
  export default {
    ...
    methods: {
      ...
      getTreeData (item, callback) {
        ...
        $http({
          path: this.apis.productCate.tree,
          method: 'get',
          data: data
        }).then(response => {
